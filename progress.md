...
2026-09-14: ORKA-ymk.8 clears transient action locks when session/AF offers take and release input, then reapplies that safe release after the Quest-QA pause snapshot restores. Destiny now resumes native autocombat and heals on subsequent personal turns. Fresh-session party draws exclude Dawn Chorus revive cards; later level-up draws retain them. Focused Node contracts passed 35/35, app boundary passed 4/4, and live in-app QA confirmed the opening exclusion plus continued turns after Destiny.
