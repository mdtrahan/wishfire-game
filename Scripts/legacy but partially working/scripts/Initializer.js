...
import { EnemySpawner, SpawnEnemies, ClearEnemies } from "./EnemySpawner.js";
...
export async function LoadEnemiesComplete(runtime) {
    ...
    console.log("[ENEMY] Using EnemySpawner system...");

    try {
        const enemies = SpawnEnemies(runtime, {
            layerName: "Enemies",
            slots: g.Slots || 3
        });
        ...
        console.error("[ENEMY] Spawner error:", e.message);
