export const state = {
  ...
  globals: {
    ...
    AstralFlowKoOrbPresentationPending: 0,
    AstralFlowKoOrbPresentationActive: 0,
    SkillDraughtOpen: 0,
    ...
    HeroTurnCardFanStateByHeroName: {},
    HeroTurnCardFanSessionId: 0,
    HeroTurnCardFanTurnSerial: 0,
    ...
    HeroGemProgressDirty: 0,
    HeroGemProgressLastChangedAt: 0,
    HeroGemProgressPersistedAt: 0,
    HeroSkillPointsByHeroId: {},
    HeroSkillPointsByUID: {},
    HeroSkillPointLedger: [],
    HeroSkillPointLedgerSeq: 0,
    HeroSkillPointRewardTrace: [],
    HeroSkillProgressByHeroId: {},
    HeroSkillProgressTrace: [],
    HeroSkillProgressTraceSeq: 0,
    TokenWallet: {},
    LiveOpsProgress: {},
