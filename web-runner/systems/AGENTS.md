...
- `combatAttackVfxPresentation.mjs` owns the short raster projectile, Split sweep and contact-flare presentation declared by pending hero-hit packets. Ranged projectiles start from the caster's rendered resting base.
