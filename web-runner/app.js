...
async function main(){
  ...
  function drawFrame(dtOverride){
    ...
    renderBoard.renderBoard(ctx, gameState, uiState.getUIState(), animationMath, {
      boardGeometry,
      worldToCanvas,
      layoutScale,
      gemFrameImages,
    ...
    state.globals.LastCombatOverlayData = combatRenderResult.overlayData;
    state.globals.LastCombatVisualFlags = combatRenderResult.visualFlags;
