...
export function normalizeGameStateEnvelope(input = {}) {
...
export function getGameStateEnvelopeShape(envelope = {}) {
...
export function createGameStateEnvelopeSimulationPacket({
  source = 'unknown',
  state = {},
  action = {},
  rngState = {},
...
export const gameStateEnvelopeConstants = Object.freeze({
