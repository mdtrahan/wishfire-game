...
import {grantFlow} from './combatRules.mjs';
export {FLOW_MODES};
...
export function earnPersonalFlow(hero,event,amount=0,maxHP=hero?.maxHP,suppressed=false){return grantFlow(hero,event,amount,suppressed?{flowOwnerUID:hero?.uid}:{});}
