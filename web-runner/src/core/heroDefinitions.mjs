...
export const FLOW_MODES = Object.freeze({Stoic:'Taking enemy damage',Warrior:'Damaging enemies',Slayer:'Defeating enemies',Healer:'Restoring missing hero HP',Tactician:'Applying or refreshing enemy debuffs',Comrade:'Allies taking enemy damage',Dancer:'Evading a hit',Rook:'Preventing enemy damage',Daredevil:'Starting a turn at critical HP',Loner:'Acting as the sole surviving hero'});
export const COMBAT_TUNING = Object.freeze({ flowMax:100, flowPerEvent:25, criticalHP:0.25, blindPenalty:0.35, accuracy:1, evasion:0, counterPotency:1, damageFlowScale:200, comradeFlowScale:100, damageFlowCap:50 });
