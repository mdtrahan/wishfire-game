...
export const PROGRESSION = Object.freeze({ maxLevel:50, expBase:100, expExponent:1.5, maxSP:100, startingSP:100, passiveSPRegenPerTurn:5, activeLevels:[1,1,5,15,20,30,40], passiveLevels:[1,10,20,25,35,45], enemyEXP:25 });
export const FLOW_ORB_TUNING = Object.freeze({flowMax:100,limitOrbDropChance:.35,limitOrbValue:10,limitOrbDropCount:1,maxDropsPerAction:1,orbChancePer:'action',guaranteedDrops:0,releaseSeconds:.14,flightSeconds:.38,collectFlashSeconds:.12,
 passives:{Stoic:{chance:.25},Warrior:{chanceBonus:.15},Slayer:{guaranteed:1,chance:.25},Healer:{chance:.30},Tactician:{chance:.35},Comrade:{chance:.15},Dancer:{chance:.50},Rook:{chance:.35,minimumPrevented:1},Daredevil:{criticalHP:.25,chanceBonus:.25},Loner:{chance:.70}}});
export const FLOW_MODES = Object.freeze({Stoic:'25% chance of a bonus orb when damaged',Warrior:'Normal attack orb chance rises to 50%',Slayer:'One bonus orb per kill; 25% chance of a second',Healer:'30% orb chance after restoring HP, once per action',Tactician:'35% orb chance after a successful debuff, once per action',Comrade:'15% orb chance when an ally is damaged, once per enemy action',Dancer:'50% orb chance after evading an attack',Rook:'35% orb chance after preventing enemy damage',Daredevil:'Normal action orb chance rises to 60% at 25% HP or less',Loner:'Normal action orb chance becomes 70% while alone'});
...
function kit(key,name,role,mode,baseStats,growth,actives,passives,special){
 ...
 basic:skill('basic_attack','Attack',0,'enemy',['physical'],[damage()],'Attack one enemy.',{unlockLevel:1})};
}
export const HERO_DEFINITIONS=Object.freeze({
 Falie:kit('Falie','Fara','Tank','Stoic',{HP:42,ATK:10,DEF:8,MAG:4,RES:6,SPD:8},{HP:8,ATK:1.2,DEF:2,MAG:0.5,RES:1,SPD:0.2},[
 ...
 Huun:kit('Huun','Hondo','DPS / Fighter','Warrior',{HP:35,ATK:14,DEF:5,MAG:4,RES:4,SPD:12},{HP:6,ATK:2.2,DEF:1,MAG:0.5,RES:0.8,SPD:0.4},[
 ...
 Runa:kit('Runa','Runa','Controller','Tactician',{HP:30,ATK:5,DEF:4,MAG:14,RES:9,SPD:10},{HP:5,ATK:0.5,DEF:0.8,MAG:2.2,RES:1.5,SPD:0.3},[
 ...
 Kojonn:kit('Kojonn','Kaja','Support / Guardian','Comrade',{HP:40,ATK:6,DEF:6,MAG:10,RES:10,SPD:11},{HP:6,ATK:0.7,DEF:1,MAG:1.6,RES:1.8,SPD:0.3},[
