# ORKA-p3rw: [BUG] Clear Skills dev button does not visibly clear session skill state
...
- Mirror issue: [#39](https://github.com/mdtrahan/wishfire-game/issues/39)
- Proposed review branch: `bead/ORKA-p3rw-bug-clear-skills-dev-button-does-not-visibly-clear-session-skill`
