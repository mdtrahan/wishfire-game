# ORKA-o2ww: [FEAT] Hero legacy unlock state and Spirit grant contract
...
- Mirror issue: [#119](https://github.com/mdtrahan/wishfire-game/issues/119)
- Proposed review branch: `bead/ORKA-o2ww-feat-hero-legacy-unlock-state-and-spirit-grant-contract`
