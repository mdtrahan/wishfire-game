# ORKA-b2c: [REF] TASK-006 Transition-depth suspend/resume validation
...
- Mirror issue: [#34](https://github.com/mdtrahan/wishfire-game/issues/34)
- Proposed review branch: `bead/ORKA-b2c-ref-task-006-transition-depth-suspend-resume-validation`
