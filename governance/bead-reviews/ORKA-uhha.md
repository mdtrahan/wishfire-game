# ORKA-uhha: [DEV] Skill ID harness and side-panel skill test readout
...
- Mirror issue: [#40](https://github.com/mdtrahan/wishfire-game/issues/40)
- Proposed review branch: `bead/ORKA-uhha-dev-skill-id-harness-and-side-panel-skill-test-readout`
