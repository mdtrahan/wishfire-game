# ORKA-zih: [EPIC] Hero Class Identity Restoration (traits + support/debuff reliability)
...
- Mirror issue: [#47](https://github.com/mdtrahan/wishfire-game/issues/47)
- Proposed review branch: `bead/ORKA-zih-epic-hero-class-identity-restoration-traits-support-debuff-relia`
