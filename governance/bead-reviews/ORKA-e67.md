# ORKA-e67: [STUB] Enemy-death loot fly-up visual hook (art pending)
...
- Mirror issue: [#33](https://github.com/mdtrahan/wishfire-game/issues/33)
- Proposed review branch: `bead/ORKA-e67-stub-enemy-death-loot-fly-up-visual-hook-art-pending`
