# ORKA-qw2o: [FEAT] Story trigger framework for node-based and non-node hero campaigns
...
- Mirror issue: [#111](https://github.com/mdtrahan/wishfire-game/issues/111)
- Proposed review branch: `bead/ORKA-qw2o-feat-story-trigger-framework-for-node-based-and-non-node-hero-ca`
