# ORKA-rrxj.4: [FEAT] Vault relic passive state foundation
...
- Mirror issue: [#41](https://github.com/mdtrahan/wishfire-game/issues/41)
- Proposed review branch: `bead/ORKA-rrxj.4-feat-vault-relic-passive-state-foundation`
...
| Blockers | ORKA-rrxj, ORKA-rrxj.2 |
| Blocks | None |
