# ORKA-7c0: [EPIC] Hero Screen Placeholder V1 (Figma-parity runtime UI)
...
- Mirror issue: [#46](https://github.com/mdtrahan/wishfire-game/issues/46)
- Proposed review branch: `bead/ORKA-7c0-epic-hero-screen-placeholder-v1-figma-parity-runtime-ui`
