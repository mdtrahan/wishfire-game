# ORKA-39i0: [BUG] Turn loop regression after status-effect presentation edits
...
- Mirror issue: [#28](https://github.com/mdtrahan/wishfire-game/issues/28)
- Proposed review branch: `bead/ORKA-39i0-bug-turn-loop-regression-after-status-effect-presentation-edits`
