# ORKA-arti: [FEAT] Relic passive tier structure and Hall upgrade data model
...
- Mirror issue: [#114](https://github.com/mdtrahan/wishfire-game/issues/114)
- Proposed review branch: `bead/ORKA-arti-feat-relic-passive-tier-structure-and-hall-upgrade-data-model`
