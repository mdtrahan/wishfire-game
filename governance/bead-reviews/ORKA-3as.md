# ORKA-3as: [FEAT] Escort NPC party scaffold with variable hero count
...
- Mirror issue: [#120](https://github.com/mdtrahan/wishfire-game/issues/120)
- Proposed review branch: `bead/ORKA-3as-feat-escort-npc-party-scaffold-with-variable-hero-count`
