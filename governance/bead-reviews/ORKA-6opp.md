# ORKA-6opp: [FEAT] Hero-specific red single-target attack presentation variants
...
- Mirror issue: [#29](https://github.com/mdtrahan/wishfire-game/issues/29)
- Proposed review branch: `bead/ORKA-6opp-feat-hero-specific-red-single-target-attack-presentation-variant`
