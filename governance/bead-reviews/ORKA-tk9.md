# ORKA-tk9: [FEAT] TASK-010 Tower war-beacon map loop
...
- Mirror issue: [#31](https://github.com/mdtrahan/wishfire-game/issues/31)
- Proposed review branch: `bead/ORKA-tk9-feat-task-010-tower-war-beacon-map-loop`
