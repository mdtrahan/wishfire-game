# ORKA-mgpd: [FEAT] Event hero participation modes runtime scaffold
...
- Mirror issue: [#116](https://github.com/mdtrahan/wishfire-game/issues/116)
- Proposed review branch: `bead/ORKA-mgpd-feat-event-hero-participation-modes-runtime-scaffold`
