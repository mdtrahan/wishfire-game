# ORKA-zvq1: [BUG] Amped attacks do not always express increased damage
...
- Mirror issue: [#37](https://github.com/mdtrahan/wishfire-game/issues/37)
- Proposed review branch: `bead/ORKA-zvq1-bug-amped-attacks-do-not-always-express-increased-damage`
